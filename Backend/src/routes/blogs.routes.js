...
router.get("/posts/admin/:slug", async (req, res) => {
  try {
    ...
    console.error("Admin single post error:", err);
    res.status(500).json({ success: false, message: "Server error" });
  }
});
...
router.post("/posts", async (req, res) => {
  try {
    ...
    // For now, use the author data from frontend
...
router.patch("/posts/:slug/status", async (req, res) => {
