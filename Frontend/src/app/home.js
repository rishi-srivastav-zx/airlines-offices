...
export default function Home() {
  ...
  const handleSearch = (e) => {
    ...
    if (searchQuery.trim()) {
      router.push(
        `/directoryAirlines?airline=${encodeURIComponent(searchQuery)}`,
      );
    }
  };
    ...
    <div className="flex flex-col">
      ...
      <section className="relative min-h-[94vh] flex items-center justify-center text-center px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl w-full">
          ...
          <p className="text-base md:text-lg text-white/90 mb-10 max-w-2xl mx-auto">
            Get instant access to contact details, locations, and office hours
            for
            <br />
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            {["Dubai", "London", "New York", "Manila", "Doha"].map((city) => (
              <button
                key={city}
                onClick={() => router.push(`/directoryAirlines?city=${city}`)}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-6">
            {AIRLINES.map((airline) => (
              <div
                key={airline.id}
                onClick={() =>
                  router.push(`/directoryAirlines?airline=${airline.id}`)
                }
        ...
        <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 mb-12 flex justify-between items-end">
          <div>
            ...
            <p className="text-gray-500">
              Discover popular hubs and contact terminals worldwide.
            </p>
          </div>
          <button
      ...
      <section className="py-20 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-gray-500">
              Our database covers every corner of the world, from international
              hubs to regional support centers.
            </p>
          </div>
        </div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="relative py-20 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-bold mb-3">Global Directory</h3>
            <p className="text-gray-300 text-sm">
              Access office details for over 500 airlines in 1,200+ cities
              globally.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-300 text-sm">
              Our team regularly updates contact phone numbers and office
              addresses.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-300 text-sm">
              No sign-up required. Get the info you need to resolve travel
              issues instantly.
            </p>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
          ...
          <p className="text-gray-500">
            The latest news from the world of aviation and travel support.
          </p>
        </div>
          ...
          <div className="rounded-[2rem] p-12 md:p-16 flex flex-col md:flex-row items-center justify-between text-white shadow-2xl overflow-hidden relative bg-white/10 backdrop-blur-sm">
            ...
            <div className="relative z-10 md:w-2/3 mb-8 md:mb-0">
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-xl">
                Get in touch with our global support desk or search our
                directory for the nearest airline office.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <div className="bg-white/10 backdrop-blur-md border border-white/20 px-8 py-4 rounded-xl flex items-center">
                  ...
                  <span className="font-bold text-lg">+1-833-842-6011</span>
                </div>
              </div>
            </div>
