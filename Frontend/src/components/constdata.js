...
export const OFFICES = [
  {
    ...
    image:
      "https://avgeekery.com/wp-content/uploads/2023/11/flydubaiBoeing7879DreamlinerRender2-1920x1080.jpg",
    featured: true,
    description:
...
export const BLOG_POSTS = [
  ...
  },
  {
    ...
    date: "Jan 03, 2025",
    image:
      "https://images.unsplash.com/photo-1502920917128-1aa500764b8a?auto=format&fit=crop&q=80&w=800",
  ...
  },
  {
    ...
    date: "Feb 08, 2025",
    image:
      "https://images.unsplash.com/photo-1494415859740-21e878dd929d?auto=format&fit=crop&q=80&w=800",
...
export const airlineAbout = {
  qatar: {
    ...
    fleet:
      "Qatar Airways operates a modern fleet of nearly 200 aircraft including Airbus A350, A320, A380, and Boeing 777 and 787 Dreamliner.",
    cabins:
      "The airline offers Economy Class, award-winning Qsuite Business Class, and First Class on select long-haul routes.",
    alliance:
  ...
  etihad: {
    ...
    fleet:
      "Etihad operates a modern fleet including Airbus A320, A350, A380, and Boeing 787 Dreamliner aircraft.",
    cabins:
      "The airline offers Economy Class, Business Class, First Class, and The Residence on select Airbus A380 routes.",
    alliance:
  ...
  philippine: {
    location: "Philippine Airlines Office, Manila, Philippines.",
    overview:
      "Philippine Airlines is the flag carrier of the Philippines, known for its warm hospitality and extensive network in Asia.",
    network:
      "From its hub in Manila, the airline serves destinations across Asia, North America, Oceania, and the Middle East.",
    fleet: "The airline operates a mixed fleet of Airbus and Boeing aircraft.",
    cabins: "Economy, Premium Economy, and Business Class are available.",
    alliance: "Not a member of any major airline alliance.",
    services: "Flight bookings, cargo, and loyalty program services.",
    baggage: "Standard baggage allowances with options for excess baggage.",
    loyalty: "Mabuhay Miles is the frequent flyer program.",
    airportServices:
      "Lounge access and priority services for premium passengers.",
    support: "Customer service for booking and travel inquiries.",
    targetCustomers:
      "Leisure and business travelers, and overseas Filipino workers.",
  },
  gulf: {
    location: "Gulf Air Office, Manama, Bahrain.",
    overview: "Gulf Air is the national carrier of the Kingdom of Bahrain.",
    network:
      "It operates scheduled services to 50 destinations in 28 countries across Africa, Asia, and Europe.",
    fleet: "The fleet consists of Airbus and Boeing aircraft.",
    cabins: "Falcon Gold (Business) and Economy Class.",
    alliance: "Not part of a major alliance, but has codeshare agreements.",
    services: "Passenger and cargo services.",
    baggage: "Generous baggage allowance.",
    loyalty: "Falconflyer loyalty program.",
    airportServices: "Lounge access for premium passengers.",
    support: "24/7 customer support.",
    targetCustomers: "Business and leisure travelers in the Middle East.",
  },
  saudia: {
    location: "Saudia Office, Jeddah, Saudi Arabia.",
    overview: "Saudia is the flag carrier of Saudi Arabia, based in Jeddah.",
    network:
      "The airline flies to over 85 destinations in the Middle East, Africa, Asia, Europe, and North America.",
    fleet: "A mixed fleet of Airbus and Boeing aircraft.",
    cabins: "First, Business, and Economy Class.",
    alliance: "A member of the SkyTeam alliance.",
    services: "Full-service airline with passenger and cargo operations.",
    baggage: "Standard baggage allowance, with extra for loyalty members.",
    loyalty: "Alfursan is the frequent flyer program.",
    airportServices: "Lounges and dedicated services for premium passengers.",
    support: "Worldwide customer support centers.",
    targetCustomers: "Religious, business, and leisure travelers.",
  },
  srilankan: {
    location: "SriLankan Airlines Office, Colombo, Sri Lanka.",
    overview: "SriLankan Airlines is the flag carrier of Sri Lanka.",
    network:
      "The airline serves 113 destinations in 51 countries in Europe, the Middle East, South Asia, Southeast Asia, the Far East, North America, and Australia.",
    fleet: "A fleet of Airbus aircraft.",
    cabins: "Business and Economy Class.",
    alliance: "A member of the Oneworld alliance.",
    services: "Passenger and cargo services.",
    baggage: "Standard baggage allowance.",
    loyalty: "FlySmiLes is the loyalty program.",
    airportServices: "Serendib Lounge at Bandaranaike International Airport.",
    support: "Global contact centers.",
    targetCustomers: "Tourists and business travelers.",
  },
  wizz: {
    location: "Wizz Air Office, Budapest, Hungary.",
    overview:
      "Wizz Air is a Hungarian low-cost airline with its head office in Budapest.",
    network:
      "The airline serves many cities across Europe, as well as some destinations in North Africa and the Middle East.",
    fleet: "An all-Airbus fleet.",
    cabins: "A single-class economy cabin.",
    alliance: "None.",
    services: "Low-cost passenger services.",
    baggage: "Charges for checked baggage.",
    loyalty: "Wizz Discount Club.",
    airportServices: "Basic airport services.",
    support: "Online and call center support.",
    targetCustomers: "Budget-conscious travelers in Europe.",
  },
};
...
export const BLOG_CONTENT = {
  b1: {
    ...
    subtitle: "Are you tired of squeezing in an economy seat on Air Transat?",
    heroImage:
    ...
    cabinClasses: {
      ...
      intro:
        "To learn more about the upgrade options you need to be well-informed about the different cabin classes available on Air Transat.",
      ...
      classes: [
        ...
        },
        {
          ...
          description: "Reserved in pairs for extra space and privacy.",
        },
        {
    ...
    clubClass: {
      ...
      additionalInfo: "Available on select routes with premium experience.",
    ...
    upgradeMethods: {
      title: "How to Upgrade to Club Class on Air Transat?",
      intro:
        "Upgrades are available on select routes and subject to availability.",
