...
export default function ApprovalsPage() {
	...
	const [modalMode, setModalMode] = useState("view"); // Added: "view" or "edit"
	...
	const handlePreview = (office) => {
		...
		setModalMode("view"); // Set to view mode
		setIsModalOpen(true);
	};

	// Updated: Handle edit mode
	...
	// Updated: Handle save with FormData support matching airlineform.js
	const handleSave = async (formData) => {
		if (!selectedOffice) return;

		try {
			// Check if formData is FormData (from airlineform.js) or regular object
	...
	return (
		<>
			...
			<div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/20 to-slate-50 p-6">
				...
				{/* Modal for viewing/editing office */}
				{isModalOpen && (
					<AirlineOfficeForm
